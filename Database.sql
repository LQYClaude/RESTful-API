...
-- this table is used for storing all the request but not in use currently
/*
CREATE TABLE log
(
...
INSERT INTO log (logtype_id, description)
  VALUES (8, 'Database created');
SELECT * FROM log;
*/